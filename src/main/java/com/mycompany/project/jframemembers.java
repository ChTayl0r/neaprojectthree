 ...
 * @author ginge
 */
public class jframemembers extends javax.swing.JFrame {

    /**
     * Creates new form jframemembers
     */
    public jframemembers() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(jframemembers.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new jframemembers().setVisible(true);
            }
        });
    }
